...
const firstRowCards: CardData[] = [
  {
    ...
    title: 'Launch Your AI Agent or Service',
    description:
      'From code generated by AI coding tools to complex agent runtimes, Sealos provides the scalable  environment your AI applications need. Our built-in AI Proxy simplifies access to any model API.',
    tags: ['Serverless', 'AI Proxy', 'Auto Scale'],
    image: <AiRuntimeCard />,
  },
  {
