...
const sealosAdvantages: SealosAdvantage[] = [
  {
    ...
    description:
      'Deploy instantly with zero configuration required - just click and go live',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Automatically scales with traffic - pay only for resources you actually use',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Built-in redundancy and automatic failover ensure 99.9% uptime',
  },
  {
    icon: (
      <svg
    ...
    title: 'SSL Included',
    description:
      'Automatic SSL certificates for secure connections at no extra cost',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Advanced monitoring and performance optimization keep your app running smoothly',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Automatic backups and disaster recovery ensure your data is always safe',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Storage that grows with your needs - from GB to TB seamlessly',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Deploy across multiple regions worldwide for optimal user experience',
  },
];
