...
const translations = {
  'en': {
    ...
    description: 'Use our unified cloud platform to accelerate your application development and deployment process.',
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute left-1/2 top-1/3 h-32 w-32 -translate-x-1/2 rounded-full bg-primary/15 blur-xl"></div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-6">
          <a href={appDomain} target="_blank" rel="noopener noreferrer">
            <div
              className="relative flex cursor-pointer items-center justify-center gap-[6px] overflow-hidden rounded-md bg-[#b2e3ff] px-6 py-3 text-[#005b9c] shadow-button hover:bg-[#97D9FF] sm:px-8 sm:py-3 sm:text-base md:px-8 md:py-4"
            >
          ...
          <a
            href={`/docs`}
            className="rounded-md border-2 border-primary bg-white/80 px-6 py-3 text-sm font-medium text-primary shadow-sm transition-all hover:bg-white hover:shadow-md sm:px-8 sm:py-3 sm:text-base md:px-8 md:py-4"
          >
            {t.readDocs}
          </a>
        </div>
