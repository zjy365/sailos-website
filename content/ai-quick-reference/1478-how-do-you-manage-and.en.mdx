---
title: 'How do you manage and visualize Kubernetes metrics using Prometheus and Grafana?'
description: 'Prometheus is an open-source monitoring system responsible for collecting and storing metrics data of Kubernetes clusters, such as CPU and memory usage; Grafana is a visualization tool used to create '
