---
title: 'What are the differences between REST APIs and gRPC in microservices?'
description: 'In microservice architecture, REST APIs are based on the HTTP/1.1 standard, using text formats such as JSON or XML to implement stateless resource interaction. They are suitable for external API inter'
