---
title: 'How do you manage versioning and rollbacks for IaC deployments?'
description: 'Infrastructure as Code (IaC) defines and manages infrastructure resources through code. Version control records code changes and enables rollbacks to recover from erroneous deployment states, which is'
