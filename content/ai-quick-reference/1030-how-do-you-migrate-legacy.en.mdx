---
title: 'How do you migrate legacy applications to a multi-cloud or hybrid cloud environment?'
description: 'Legacy applications are traditional monolithic applications that reside in on-premises data centers, with high maintenance costs and technical dependencies. Migrating to a multi-cloud or hybrid cloud '
