---
title: 'How do you use observability data to inform application design decisions?'
description: 'Observability data refers to metrics (such as response time), logs (such as error records), and traces (such as request flows) collected from applications, which are used to reveal the internal system'
