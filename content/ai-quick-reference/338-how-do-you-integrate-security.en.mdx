---
title: 'How do you integrate security scans into an automated deployment pipeline?'
description: 'Integrating security scanning into the automated deployment pipeline refers to embedding automated security tools, such as Static Application Security Testing (SAST) or container image scanning, into '
