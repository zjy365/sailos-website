---
title: 'How do you integrate monitoring with CI/CD pipelines in cloud-native environments?'
description: 'In a cloud-native environment, monitoring involves collecting application performance metrics, logs, and health status, such as using Prometheus and Grafana; CI/CD pipelines implement automated build'
