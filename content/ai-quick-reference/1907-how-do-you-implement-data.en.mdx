---
title: 'How do you implement data archiving in cloud-native applications?'
description: 'Implementing data archiving in cloud-native applications is the process of migrating infrequently accessed (cold) data that needs long-term retention from high-performance storage to low-cost storage '
