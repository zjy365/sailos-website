---
title: 'How do you automate the deployment of serverless applications?'
description: 'The core of automating the deployment of serverless applications lies in implementing a continuous integration and continuous delivery pipeline from code changes to production release through toolchai'
