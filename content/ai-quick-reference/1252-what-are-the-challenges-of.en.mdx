---
title: 'What are the challenges of CI/CD for large-scale, multi-tenant applications?'
description: 'CI/CD for large-scale multi-tenant applications refers to the automated process of implementing continuous integration and continuous delivery for applications that serve multiple independent tenants.'
