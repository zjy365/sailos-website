---
title: 'How do you perform security testing during the CI/CD process?'
description: 'Performing security testing in the CI/CD process refers to the critical practice of automating the scanning of application code and infrastructure in the continuous integration and delivery pipeline t'
