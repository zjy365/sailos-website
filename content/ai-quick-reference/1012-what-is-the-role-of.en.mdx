---
title: 'What is the role of container orchestration in multi-cloud deployments?'
description: 'Container orchestration systems (such as Kubernetes) provide a unified workload management plane for multi-cloud deployments. Their core value lies in shielding differences in underlying heterogeneous'
