---
title: 'What is role-based access control (RBAC) and how does it work in Kubernetes?'
description: 'Role-Based Access Control (RBAC) is a core security mechanism for managing user or service account permissions in Kubernetes, with its core lying in the "principle of least privilege"—that is, only gr'
