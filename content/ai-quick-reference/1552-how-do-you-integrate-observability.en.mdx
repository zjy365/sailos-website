---
title: 'How do you integrate observability tools with other cloud-native security tools?'
description: 'Observability tools monitor behavioral data (such as logs, metrics, traces) of cloud-native applications, while cloud-native security tools (such as runtime protection tools) detect and respond to thr'
