---
title: 'What are the differences between declarative and imperative approaches to IaC?'
description: 'Declarative IaC describes the desired state of infrastructure, and the system automatically achieves that state, emphasizing the final result; imperative IaC specifies specific operational steps to ac'
