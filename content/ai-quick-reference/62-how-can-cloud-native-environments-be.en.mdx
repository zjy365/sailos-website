---
title: 'How can cloud-native environments be used to build serverless applications?'
description: 'Building serverless applications using cloud-native environments involves leveraging their elasticity, programmable infrastructure, and service-oriented components (such as Function-as-a-Service - Faa'
