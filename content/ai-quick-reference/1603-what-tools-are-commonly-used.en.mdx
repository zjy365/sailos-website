---
title: 'What tools are commonly used for Infrastructure as Code (IaC)?'
description: 'Infrastructure as Code (IaC) is an approach to automatically manage computing resources through machine-readable definition files (such as configuration files or scripts) rather than manual operations'
