---
title: 'How do you manage user identities and access across multiple cloud-native services?'
description: 'Managing user identities and access permissions refers to using authentication (such as OIDC) and authorization mechanisms to ensure secure and consistent access among multiple cloud-native services. '
