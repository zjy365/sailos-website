---
title: 'How do cloud-native environments simplify infrastructure management?'
description: 'Cloud-native environment is a cloud computing environment based on container, microservice, and automation technologies, whose core is to abstract the underlying infrastructure using containerization '
