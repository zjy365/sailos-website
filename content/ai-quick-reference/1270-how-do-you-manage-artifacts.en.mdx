---
title: 'How do you manage artifacts and builds in CI/CD pipelines?'
description: 'In CI/CD pipelines, artifacts (such as binary packages and container images) are the outputs of the build process, which refers to the automated phase of code compilation, testing, and packaging. Mana'
