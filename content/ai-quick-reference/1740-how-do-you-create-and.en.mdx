---
title: 'How do you create and manage custom modules in IaC workflows?'
description: 'In the IaC workflow, custom modules are reusable code blocks used to encapsulate infrastructure components (such as virtual machines or network settings). Their importance lies in reducing repetitive '
