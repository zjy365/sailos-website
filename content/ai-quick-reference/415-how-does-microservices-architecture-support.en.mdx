---
title: 'How does microservices architecture support continuous integration and delivery?'
description: 'Microservices architecture is a software design paradigm that decomposes a single application into multiple independent, loosely coupled service units. This directly supports Continuous Integration an'
