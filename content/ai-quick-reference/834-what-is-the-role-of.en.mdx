---
title: 'What is the role of OAuth and OpenID Connect in securing cloud-native applications?'
description: 'OAuth 2.0 is an authorization framework that allows applications to securely obtain limited access to HTTP services on behalf of users. OpenID Connect (OIDC) is an identity layer built on top of OAuth'
