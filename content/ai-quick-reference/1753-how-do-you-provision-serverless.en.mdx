---
title: 'How do you provision serverless infrastructure using IaC tools?'
description: 'Infrastructure as Code (IaC) automates infrastructure provisioning using code definitions, while serverless infrastructure leverages cloud services like AWS Lambda to run applications without managing'
