---
title: 'How do you ensure security compliance in automated deployment processes?'
description: 'Ensuring the security compliance of the automated deployment process refers to embedding security control points in the CI/CD pipeline to make deployments comply with security policies and regulatory '
