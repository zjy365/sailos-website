...
date: 2024-11-21
tags: ['Sealos', 'Meilisearch', 'Flarum', 'Developer Tools']
authors: ['default']
---
...
直接打开 Meilisearch 应用模板：

<DeployButton deployUrl="https://template.hzh.sealos.run/deploy?templateName=meilisearch" />
...
![Deploy Meilisearch on Sealos](./images/deploy-meilisearch-on-sealos.zh-cn.png)

部署完成后，直接点击应用的“详情”进入该应用的详情页面。

![Details of Meilisearch on Sealos](./images/details-of-meilisearch-on-sealos.zh-cn.png)
...
> 关于 Flarum 的安装和使用方法，可参考我们之前写的文章：[Flarum 安装和使用教程](./how-to-deploy-and-configure-flarum-using-docker)

### 安装 Meilisearch SDK

在 Flarum 应用详情界面，点击右下角的终端按钮：

![在 Sealos 中打开 Meilisearch 应用终端](./images/open-meilisearch-terminal-on-sealos.zh-cn.jpg)
...
![Flarum admin panel](./images/flarum-admin-panel.zh-cn.jpg)

下面还需要配置 Meilisearch 的 URL 和密钥。

![Scout extension on flarum](./images/scout-extension-on-flarum.zh-cn.jpg)
...
![Update Meilisearch on Sealos](./images/update-meilisearch-on-sealos.zh-cn.png)

将内存调整到 1G，然后点击右上角的“变更”即可。

![Change Meilisearch memory on Sealos](./images/change-meilisearch-mem-on-sealos.zh-cn.jpg)
