...
然而，调研发现这个项目目前还**处于非常早期的阶段**，遇到了一些不稳定的 Bug，比如内存泄漏导致的 OOM、pathpolicy 不生效，以及某些特性在 merge gateway 模式下无法工作等问题。虽然这些问题在持续解决中，我们也通过提交 Bug 报告和改进建议积极参与上游社区贡献，但对于我们复杂且大规模的生产需求而言，**Envoy Gateway 目前尚未达到生产就绪状态。**
