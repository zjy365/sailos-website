...
icon: Album
keywords: [Sealos DevBox, Next.js, cloud development, Kubernetes, OCI image, Cursor IDE, remote development, cloud deployment, containerization, DevOps]
...
<h5>Click on the "DevBox" icon on [Sealos Desktop](https://usw.sealos.io), then click on the "Create New Project" button to create a new project.</h5>
