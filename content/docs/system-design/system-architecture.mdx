...
![Sealos Architecture](./images/sealos-architecture.zh-cn.png)
...
应用架构以及交互情况：(以 App Launchpad 与 Terminal 应用与其交互为例子)

![Sealos Application](./images/sealos-application.zh-cn.png)
