...
2. Click "New Application" and choose a name for your bot. This name will be displayed in your Discord server
   ![Discord Developer Portal](./images/discord-dev-portal.png)
...
2. Enable required intents:
   ...
   ![Discord Developer Portal Bot Permissions](./images/discord-dev-portal-bot-permissions.png)
...
2. Select "bot" scope
   ![Discord Developer Portal Bot Scope](./images/discord-dev-portal-oauth2-bot-scope.png)
3. Choose "Administrator" permissions
   ![Discord Developer Portal Bot Permissions](./images/discord-dev-portal-oauth2-bot-permissions.png)
...
client.on('messageCreate', async message => {
  ...
  if (message.content.startsWith('!ask ')) {
    ...
    if (!question) {
      message.reply('Please enter your question after !ask. For example: !ask what is Sailos?');
      return;
    }
...
3. Choose "General Dataset" as the dataset type
   ![FastGPT Dataset Creation](./images/fastgpt-dataset-creation.png)
4. Select "Text Dataset" for document processing
5. Upload your documentation files (supports PDF, TXT, Word, etc.)
   ![FastGPT Dataset Upload](./images/fastgpt-dataset-upload.png)
...
![FastGPT Application Setup](./images/fastgpt-application-setup.png)
...
2. Go to the "API Request" section of your application
   ![FastGPT API Request](./images/fastgpt-api-request.png)
