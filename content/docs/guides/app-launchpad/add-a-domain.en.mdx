...
title: Add a Domain
keywords:
  [custom domain, Sealos, app deployment, domain provider, public access]
...
Just enable "Public Access" when you're deploying, and <AppDashboardLink /> will sorts you out with a
domain.
