---
title: Deployments
keywords: [App Launchpad, Sailos, application deployment, private images, horizontal pod autoscaling]
description: App Launchpad in Sailos simplifies application deployment with features like private images, HPA, custom domains, and real-time monitoring.
---

**App Launchpad** is a feature within Sailos that serves as a single-image deployment tool. Its main goal is to
