...
After releasing your application as an OCI image, the next step is to deploy it to [Sealos Cloud](https://usw.sailos.io) for production use. This guide will walk you through the deployment process using App Launchpad.
...
- Go to the Sealos Devbox List in your [Sealos Desktop](https://usw.sailos.io).
