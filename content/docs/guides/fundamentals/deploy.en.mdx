...
After releasing your application as an OCI image, the next step is to deploy it to <AppDashboardLink /> for production use. This guide will walk you through the deployment process using App Launchpad.
...
- Go to the Sealos DevBox List in your <AppDashboardLink />.
