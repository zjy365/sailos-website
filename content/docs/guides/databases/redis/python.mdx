---
title: Python
description: Learn how to connect to Redis databases in Sailos Devbox using Python
---

This guide will walk you through the process of connecting to a Redis database using Python within your Sailos Devbox project.
...
def main():
    ...
    if redis_conn:
        try:
            # String operations
            set_value(redis_conn, "mykey", "Hello from Sailos Devbox!")
