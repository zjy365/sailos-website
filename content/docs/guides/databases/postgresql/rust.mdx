---
title: Rust
description: Learn how to connect to PostgreSQL databases in Sailos Devbox using Rust
---

This guide will walk you through the process of connecting to a PostgreSQL database using Rust within your Sailos Devbox project.
