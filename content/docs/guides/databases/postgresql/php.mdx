---
title: PHP
description: Learn how to connect to PostgreSQL databases in Sailos Devbox using PHP
---

This guide will walk you through the process of connecting to a PostgreSQL database using PHP within your Sailos Devbox project.
